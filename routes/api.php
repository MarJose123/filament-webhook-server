...
if(filament()->isServing() && WebhookPlugin::get()->isEnabled() && WebhookPlugin::get()->isApiRoutesEnabled())
{
    Route::prefix('/webhook-server/api')->middleware('web')->group(function (): void {
